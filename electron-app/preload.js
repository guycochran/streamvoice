...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    speechReportLifecycle: (payload) => ipcRenderer.send('speech-capture-lifecycle', payload),
    speechReportError: (message) => ipcRenderer.send('speech-capture-error', message),
