...
# StreamVoice v1.0.2 Release Script
# This script creates a new GitHub release

set -e

echo "🚀 Creating StreamVoice v1.0.2 Release..."

# Configuration
REPO="guycochran/streamvoice"
TAG="v1.0.2"
TITLE="StreamVoice v1.0.2 - Complete IPv6 Fix 🎯"
RELEASE_NOTES_FILE="./release-prep/RELEASE_NOTES_v1.0.2.md"
...
echo ""
echo "🎉 Release v1.0.2 is now live!"
echo ""
