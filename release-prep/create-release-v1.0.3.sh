...
# StreamVoice v1.0.3 Release Script
# This script creates a new GitHub release

set -e

echo "🚀 Creating StreamVoice v1.0.3 Release..."

# Configuration
REPO="guycochran/streamvoice"
TAG="v1.0.3"
TITLE="StreamVoice v1.0.3 - Final IPv6 Fix! 🚀"
RELEASE_NOTES_FILE="./release-prep/RELEASE_NOTES_v1.0.3.md"
...
echo ""
echo "🎉 Release v1.0.3 is now live!"
echo ""
