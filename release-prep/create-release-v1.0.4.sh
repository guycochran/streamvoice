...
# StreamVoice v1.0.4 Release Script
# This script creates a new GitHub release

set -e

echo "🚀 Creating StreamVoice v1.0.4 Release..."

# Configuration
REPO="guycochran/streamvoice"
TAG="v1.0.4"
TITLE="StreamVoice v1.0.4 - NOW IT JUST WORKS! 🎮"
RELEASE_NOTES_FILE="./release-prep/RELEASE_NOTES_v1.0.4.md"
...
echo ""
echo "🎉 Release v1.0.4 is now live!"
echo ""
