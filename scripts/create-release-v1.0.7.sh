...
# StreamVoice v1.0.7 Release Script
...
TAG="v1.0.7"
RELEASE_TITLE="StreamVoice v1.0.7 - Frontend Communication Fix"

# Read the release notes
RELEASE_NOTES=$(cat RELEASE_NOTES_v1.0.7.md)

echo "📦 Creating StreamVoice v1.0.7 Release..."
