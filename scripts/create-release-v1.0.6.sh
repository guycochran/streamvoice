...
# StreamVoice v1.0.6 Release Script
...
TAG="v1.0.6"
RELEASE_TITLE="StreamVoice v1.0.6 - Critical Server Fix"

# Read the release notes
RELEASE_NOTES=$(cat RELEASE_NOTES_v1.0.6.md)

echo "📦 Creating StreamVoice v1.0.6 Release..."
